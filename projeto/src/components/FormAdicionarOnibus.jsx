...
function FormAdicionarOnibus() {
    ...
    const handleSubmit = async (e) => {
        ...
        alert("adição realizada")

        let tipo_metodo = 'POST';
        
        const url_adicionarOnibus = 'http://localhost/Projeto3DAW_WebApp/backEnd/adicionarOnibus.php';

        let dados = await FetchRequest(url_adicionarOnibus, tipo_metodo, formData);
  ...
  export default FormAdicionarOnibus